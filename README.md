...
If you are looking for a simple HTML/vanilla JavaScript version, check [here](https://github.com/IntellaCoder/chatgpt-web)

![Demo Gif](/client/src/img/demo2.gif)

<a href="https://www.buymeacoffee.com/IntellaCoder" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/default-orange.png" alt="Buy Me A Coffee" height="51" width="217"></a>
...
```sh
git clone https://github.com/IntellaCoder/chatgpt-web
```
